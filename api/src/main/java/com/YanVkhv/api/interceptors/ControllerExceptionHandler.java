package com.YanVkhv.api.interceptors;

import com.YanVkhv.infrastructure.exceptions.EntityNotFoundException;
import com.YanVkhv.infrastructure.exceptions.EntityNotValidException;
import com.YanVkhv.infrastructure.exceptions.NotAuthorizedException;
...
@ControllerAdvice(basePackages = "com.YanVkhv.api")
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public static class Error {
        ...
        private String getMessage(Exception exception) {
            ...
            return "Something went wrong, please review your request and try again.";
        }
