...
INSERT INTO SUBSCRIBER (SUBSCRIPTION_ID, ADDRESS_ID, FIRSTNAME, LASTNAME, BIRTHDATE, DEATHDATE, GENDER,
                        NATIONAL_REGISTER_NUMBER)
VALUES (1, 1, 'Tom', 'Cruise', '1962-07-03', null, 'MALE', 67070322361),
       (2, 2, 'Harry', 'Potter', '1988-11-06', null, 'MALE', 67089332361),
       (3, 3, 'Jane', 'Doe', '1944-01-15', null, 'FEMALE', 53550322361);
